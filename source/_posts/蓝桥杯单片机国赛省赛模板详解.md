...
>此外，主包额外做了[一点探究](https://www.genkaim.top/posts/abb27f10). 
>
...
>笔者2026.6.6考后按：
>注意温度存储的数据有16位两个字节，需要用**两个**`unsigned char`或一个`unsigned int`存. 千万不要只用一个`unsigned char`导致数据截断. 不然你会获得10摄氏度的空调房.
...
[https://github.com/Genkaim/LQ15th-danpianji-guosai](https://github.com/Genkaim/LQ15th-danpianji-guosai)