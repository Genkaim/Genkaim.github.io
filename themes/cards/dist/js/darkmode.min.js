(() => {
  const e = document.documentElement,
    ...
    m = { dark: !0, light: !0 },
    a = (a) => {
      const n = a || t("user-color-scheme");
      document.getElementById("hl-dark-theme")
        ? m[n]
          ? "dark" === n
          ...
          : ((document.getElementById("hl-dark-theme").media = "none"),
            (document.getElementById("hl-default-theme").media = "all"))
        : document.getElementById("hl-default-theme") &&
          (document.getElementById("hl-default-theme").media = "all"),
        n === l()
          ? d()
          : m[n]
          ? e.setAttribute("data-user-color-scheme", n)
          : d();
    },
    n = { dark: "light", light: "dark" },
    r = () => {
  ...
  a(),
    (window.onload = () => {
      document
        .getElementById("btn-toggle-dark")
